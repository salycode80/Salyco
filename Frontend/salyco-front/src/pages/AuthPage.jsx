...
export default function AuthPage() {
  ...
  return (
    <div
      className="min-h-screen grid grid-cols-1 font-[Vazirmatn,sans-serif]"
      style={{ paddingTop: "var(--navbar-height, 120px)" }}
    >
      <div className="flex items-center justify-center bg-[#F5F7FA] px-5 py-12">
