...
function DealerCard({ dealer }) {
  return (
    <article
      dir="ltr"
      className="group flex w-full flex-col overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-[#e2e8f0] transition hover:shadow-md hover:-translate-y-0.5 md:flex-row"
    >
      ...
      <a
        ...
        className="relative h-48 w-full shrink-0 overflow-hidden bg-[#e8edf8] md:h-auto md:w-1/4"
      >
        {dealer.image ? (
          <img
            src={dealer.image}
          ...
          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#dde6f7] to-[#c3d3ef]">
            <MapPin
              className="h-12 w-12 text-[#7b9fd4] opacity-60"
              strokeWidth={1.5}
            />
          </div>
        )}
        ...
        <span className="absolute bottom-3 left-3 inline-flex items-center gap-1 rounded-full bg-white/90 px-2.5 py-1 text-xs font-medium text-[#000c3e] opacity-0 transition group-hover:opacity-100">
      ...
      <div
        ...
        dir="rtl"
      >
        <h3 className="font-persian text-lg font-bold text-[#000c3e] md:text-xl">
          {dealer.name}
        </h3>

        <div className="flex items-start gap-2.5 font-persian text-sm leading-relaxed text-[#4b5a78]">
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 pt-1">
          {dealer.phone && (
            <a
              ...
              className="flex items-center gap-2 font-persian text-sm text-[#4b5a78] transition hover:text-[#2563eb]"
              dir="ltr"
            >
          ...
          {dealer.hours && (
            <div className="flex items-center gap-2 font-persian text-sm text-[#4b5a78]">
